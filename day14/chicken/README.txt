...
With the current recipes' scores of 3 and 7,their sum is 10, and so two new recipes would be created: the first
with score 1 and the second with score 0.
...
For example:
    ...
    after the first nine on the scoreboard would be 5158916779
