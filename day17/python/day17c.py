...
class AnimationWindow:
    ...
    def __init__(self, root):
        ...
        for key in water:
            ...
            if (y < minY):
                remkeys = remkeys + [key]
        print(f"There needs to be {len(remkeys)} keys removed since larger than grid")
        
        if (500,0) in water:
            print("sprinkler at 500,0 is included in water")
        else:
            print("sprinkler at 500,0 is NOT included in water")
        # finally > 30622 
        print(f"True solution minus water drops before minY is {30640 - len(remkeys)}")
...
# solution seems visually acceptable is it the right answer ?    
# todos size => 0
# water size => 30640
#
