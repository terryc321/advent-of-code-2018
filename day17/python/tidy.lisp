...
;; ranges define the clay bricks
;; generate a big 2 dimensional grid with proc being procedure to call
;; to find if there is a clay brick there - returns 1 if there is , otherwise if not 
...
;; (enforce-check-all-bricks-have-cups a g)
;; => nil 
