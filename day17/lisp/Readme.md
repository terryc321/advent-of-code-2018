...
water o falls down until it hits something (h) concrete or goes out of range

decide to left / right 
we may have hit an edge of cup 
...
```
+ sprinkler - the sprinkler stays at x = 500 , y = 0
o falling water
? decision to go left / right but for how far

is there a wall to my right ? no .....
is there floor to my right + one step down ? no ... edge of cup { go right ; go down ; keep going down until hit cup

idea is only the water falling has the ability to determine to go left or right
